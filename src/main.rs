...
use std::vec::Vec;
use crate::raytracer::shapes::group::Group;
...
fn main() {
    ...
    let width = clamp::<u32>((WIDTH as f32 * res_multiplier).into(), 0, 8126);
    let height = clamp::<u32>((HEIGHT as f32 * res_multiplier).into(), 0, 8126);
